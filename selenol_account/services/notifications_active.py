...
"""Selenol service that returns all the active user notifications."""
...
class AccountNotificationsActive(SelenolService):
    ...
    def __init__(self, connection=None, session=None):
        ...
        """
        super(AccountNotificationsActive, self).__init__(
            ['account', 'notifications', 'active'], connection, session)
    ...
    def on_request(self, user):
        ...
        """
        return [notification_serializer(notification) for notification in
